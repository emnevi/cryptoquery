const UIMessages = {
    Spanish: {
        ...
        gainsPerTx: "Ganancias por Tx",
        last: "Ultimas",
        lastEnd: "transacciones recibidas",
        noTxFound: "No se encontraron transacciones",
        card1Title: "Sigue el Crecimiento de tu Cripto",
        card1Text: "Ingresa tu cartera de Bitcoin, Ethereum o Cardano, y te ayudamos a rastrear cualquier transacción entrante. Es una forma rápida y fácil de ver cómo ha crecido tu inversión con el tiempo.",
    ...
    English: {
        ...
        subtitle: "Simply enter your wallet address, and we’ll calculate your gains.",
        inputPlaceholer: "Enter crypto wallet address...",
        addresses: "Supported addresses",
        actionButton: "Go!",
        explanation: "We’ve analyzed all incoming transactions to your wallet and compared the value at the time of each transaction to the current market price.",
        rightNow: "right now",
        gainsPerTx: "Gains per Tx",
        last: "Last",
        lastEnd: "transactions received",
        noTxFound: "No transactions found",
        card1Title: "Track Your Crypto Growth",
        card1Text: "Enter your Bitcoin, Ethereum, or Cardano wallet, and we'll help you track any incoming transactions. It's a quick and easy way to see how your investment has grown over time.",
